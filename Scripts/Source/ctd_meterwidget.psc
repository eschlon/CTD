scriptname ctd_MeterWidget extends SKI_WidgetBase

; Chesko's Frostfall MeterWidget. All credit to chesko.tesmod@gmail.com
...
event OnWidgetReset()
	debug.trace("[CTD] SKI_MeterWidget OnWidgetReset()")
